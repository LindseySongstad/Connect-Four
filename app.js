document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index) {
        ...
        squares[i].onclick = function() {
            //if square below is taken, you can go on top
            ...
            // if the square below isn't taken, you can't go there    
    ...
    function checkBoard() {
        ...
        // now take the 4 vlaies of each winning array
        for (let y = 0; y < winningArrays.length; y++) {
            ...
            // check those arrays to see if all are player ones
